        ...
        if feedback is None:
            ...
            if same_indices_data:
                if len(same_indices_data) == 1:
                    ...
                    feedback = (f"All passwords generated by your function have the same character at "
                                f"{formatted_details}.")
            elif char_union == char_intersection:
                feedback = f"All passwords generated by your function have the same characters {tuple(char_union)}."
